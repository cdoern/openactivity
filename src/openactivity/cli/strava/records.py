"""Strava personal records commands."""
    ...
    try:
        ...
        if not use_json:
            with Progress() as progress:
                ...
                result = scan_all_activities(session, full=full)
    ...
    try:
        ...
        if not records:
            console.print(
                ...
                "Run 'openactivity strava records scan' first."
            )
            return
        ...
        console.print(
            "\nView PR history: "
            "[bold]openactivity strava records history --distance <LABEL>[/bold]"
        )
    ...
    try:
        ...
        if use_json:
            ...
            console.print(
                ...
                f"Run 'openactivity strava records scan' to detect PRs."
            )
